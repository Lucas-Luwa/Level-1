...
public class EatMe extends KeyAdapter {
	...
	private void makeAlbum() {
		// 1. Find 3 images of foods eaten by different utensils and put them in
		...
		images.put(new Integer(KeyEvent.VK_DOWN), "apple.jpg");
		images.put(new Integer(KeyEvent.VK_LEFT), "rice.jpg"); // the chopstick will be connected to the LEFT key
	...
	public void keyPressed(KeyEvent e) {
		...
		System.out.println(whichKeyPressed + " was pressed.");
		...
		// 11. Otherwise, tell the user that they should learn some manners
			...
			System.out.println("You NEED to learn some manners!");
		}
